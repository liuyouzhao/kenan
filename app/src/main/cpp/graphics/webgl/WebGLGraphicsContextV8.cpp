...
#undef LOGI
#undef LOGE
#define  LOG_TAG    "WebGLGraphicsContextV8"
...
v8::Handle<v8::Value> WebGLGraphicsContext::wrap(const v8::internal::Arguments& args)
{
    HandleScope scope;
    ...
    class_proto->Set(v8::String::New("viewport"),FunctionTemplate::New(WebGLGraphicsContext::ViewPort));
    class_proto->Set(v8::String::New("clear"),FunctionTemplate::New(WebGLGraphicsContext::Clear));
    class_proto->Set(v8::String::New("clearColor"),FunctionTemplate::New(WebGLGraphicsContext::ClearColor));
    class_proto->Set(v8::String::New("createBuffer"),FunctionTemplate::New(WebGLGraphicsContext::CreateBuffer));
    class_proto->Set(v8::String::New("createTexture"),FunctionTemplate::New(WebGLGraphicsContext::CreateTexture));
    class_proto->Set(v8::String::New("createShader"),FunctionTemplate::New(WebGLGraphicsContext::CreateShader));
    class_proto->Set(v8::String::New("createRenderbuffer"),FunctionTemplate::New(WebGLGraphicsContext::CreateRenderbuffer));
    class_proto->Set(v8::String::New("createFramebuffer"),FunctionTemplate::New(WebGLGraphicsContext::CreateFramebuffer));
    class_proto->Set(v8::String::New("createProgram"),FunctionTemplate::New(WebGLGraphicsContext::CreateProgram));
    class_proto->Set(v8::String::New("bindBuffer"),FunctionTemplate::New(WebGLGraphicsContext::BindBuffer));
    class_proto->Set(v8::String::New("bindTexture"),FunctionTemplate::New(WebGLGraphicsContext::BindTexture));
    class_proto->Set(v8::String::New("bufferData"),FunctionTemplate::New(WebGLGraphicsContext::BufferData));
    class_proto->Set(v8::String::New("bufferSubData"),FunctionTemplate::New(WebGLGraphicsContext::BufferSubData));
    class_proto->Set(v8::String::New("shaderSource"),FunctionTemplate::New(WebGLGraphicsContext::ShaderSource));
    class_proto->Set(v8::String::New("compileShader"),FunctionTemplate::New(WebGLGraphicsContext::CompileShader));
    class_proto->Set(v8::String::New("getAttribLocation"),FunctionTemplate::New(WebGLGraphicsContext::GetAttribLocation));
    class_proto->Set(v8::String::New("getUniformLocation"),FunctionTemplate::New(WebGLGraphicsContext::GetUniformLocation));
    class_proto->Set(v8::String::New("enableVertexAttribArray"),FunctionTemplate::New(WebGLGraphicsContext::EnableVertexAttribArray));
    class_proto->Set(v8::String::New("vertexAttribPointer"),FunctionTemplate::New(WebGLGraphicsContext::VertexAttribPointer));
    class_proto->Set(v8::String::New("drawArrays"),FunctionTemplate::New(WebGLGraphicsContext::DrawArrays));
    class_proto->Set(v8::String::New("attachShader"),FunctionTemplate::New(WebGLGraphicsContext::AttachShader));
    class_proto->Set(v8::String::New("linkProgram"),FunctionTemplate::New(WebGLGraphicsContext::LinkProgram));
    class_proto->Set(v8::String::New("useProgram"),FunctionTemplate::New(WebGLGraphicsContext::UseProgram));
    class_proto->Set(v8::String::New("enable"),FunctionTemplate::New(WebGLGraphicsContext::Enable));
    class_proto->Set(v8::String::New("disable"),FunctionTemplate::New(WebGLGraphicsContext::Disable));
    class_proto->Set(v8::String::New("depthFunc"),FunctionTemplate::New(WebGLGraphicsContext::DepthFunc));
    class_proto->Set(v8::String::New("clearDepth"),FunctionTemplate::New(WebGLGraphicsContext::ClearDepth));
    class_proto->Set(v8::String::New("drawElements"),FunctionTemplate::New(WebGLGraphicsContext::DrawElements));
    class_proto->Set(v8::String::New("flush"),FunctionTemplate::New(WebGLGraphicsContext::Flush));
    class_proto->Set(v8::String::New("getShaderInfoLog"),FunctionTemplate::New(WebGLGraphicsContext::GetShaderInfoLog));
    class_proto->Set(v8::String::New("texImage2D"),FunctionTemplate::New(WebGLGraphicsContext::TexImage2D));
    class_proto->Set(v8::String::New("activeTexture"),FunctionTemplate::New(WebGLGraphicsContext::ActiveTexture));
    class_proto->Set(v8::String::New("generateMipmap"),FunctionTemplate::New(WebGLGraphicsContext::GenerateMipmap));
    class_proto->Set(v8::String::New("pixelStorei"),FunctionTemplate::New(WebGLGraphicsContext::PixelStorei));
    class_proto->Set(v8::String::New("bindFramebuffer"),FunctionTemplate::New(WebGLGraphicsContext::BindFramebuffer));
    class_proto->Set(v8::String::New("bindRenderbuffer"),FunctionTemplate::New(WebGLGraphicsContext::BindRenderbuffer));
    class_proto->Set(v8::String::New("renderbufferStorage"),FunctionTemplate::New(WebGLGraphicsContext::RenderbufferStorage));
    class_proto->Set(v8::String::New("framebufferTexture2D"),FunctionTemplate::New(WebGLGraphicsContext::FramebufferTexture2D));
    class_proto->Set(v8::String::New("framebufferRenderbuffer"),FunctionTemplate::New(WebGLGraphicsContext::FramebufferRenderbuffer));

    class_proto->Set(v8::String::New("swapBuffer"),FunctionTemplate::New(WebGLGraphicsContext::SwapBuffer));

    class_proto->Set(v8::String::New("texParameterf"),FunctionTemplate::New(WebGLGraphicsContext::TexParameterf));
    class_proto->Set(v8::String::New("texParameteri"),FunctionTemplate::New(WebGLGraphicsContext::TexParameteri));

    class_proto->Set(v8::String::New("uniform1f"),FunctionTemplate::New(WebGLGraphicsContext::Uniform1f));
    class_proto->Set(v8::String::New("uniform1fv"),FunctionTemplate::New(WebGLGraphicsContext::Uniform1fv));
    class_proto->Set(v8::String::New("uniform1i"),FunctionTemplate::New(WebGLGraphicsContext::Uniform1i));
    class_proto->Set(v8::String::New("uniform1iv"),FunctionTemplate::New(WebGLGraphicsContext::Uniform1iv));
    class_proto->Set(v8::String::New("uniform2f"),FunctionTemplate::New(WebGLGraphicsContext::Uniform2f));
    class_proto->Set(v8::String::New("uniform2fv"),FunctionTemplate::New(WebGLGraphicsContext::Uniform2fv));
    class_proto->Set(v8::String::New("uniform2i"),FunctionTemplate::New(WebGLGraphicsContext::Uniform2i));
    class_proto->Set(v8::String::New("uniform2iv"),FunctionTemplate::New(WebGLGraphicsContext::Uniform2iv));
    class_proto->Set(v8::String::New("uniform3f"),FunctionTemplate::New(WebGLGraphicsContext::Uniform3f));
    class_proto->Set(v8::String::New("uniform3fv"),FunctionTemplate::New(WebGLGraphicsContext::Uniform3fv));
    class_proto->Set(v8::String::New("uniform3i"),FunctionTemplate::New(WebGLGraphicsContext::Uniform3i));
    class_proto->Set(v8::String::New("uniform3iv"),FunctionTemplate::New(WebGLGraphicsContext::Uniform3iv));
    class_proto->Set(v8::String::New("uniform4f"),FunctionTemplate::New(WebGLGraphicsContext::Uniform4f));
    class_proto->Set(v8::String::New("uniform4fv"),FunctionTemplate::New(WebGLGraphicsContext::Uniform4fv));
    class_proto->Set(v8::String::New("uniform4i"),FunctionTemplate::New(WebGLGraphicsContext::Uniform4i));
    class_proto->Set(v8::String::New("uniform4iv"),FunctionTemplate::New(WebGLGraphicsContext::Uniform4iv));
    class_proto->Set(v8::String::New("uniformMatrix2fv"),FunctionTemplate::New(WebGLGraphicsContext::UniformMatrix2fv));
    class_proto->Set(v8::String::New("uniformMatrix3fv"),FunctionTemplate::New(WebGLGraphicsContext::UniformMatrix3fv));
    class_proto->Set(v8::String::New("uniformMatrix4fv"),FunctionTemplate::New(WebGLGraphicsContext::UniformMatrix4fv));

    class_proto->Set(v8::String::New("vertexAttrib1f"),FunctionTemplate::New(WebGLGraphicsContext::VertexAttrib1f));
    class_proto->Set(v8::String::New("vertexAttrib1fv"),FunctionTemplate::New(WebGLGraphicsContext::VertexAttrib1fv));
    class_proto->Set(v8::String::New("vertexAttrib2f"),FunctionTemplate::New(WebGLGraphicsContext::VertexAttrib2f));
    class_proto->Set(v8::String::New("vertexAttrib2fv"),FunctionTemplate::New(WebGLGraphicsContext::VertexAttrib2fv));
    class_proto->Set(v8::String::New("vertexAttrib3f"),FunctionTemplate::New(WebGLGraphicsContext::VertexAttrib3f));
    class_proto->Set(v8::String::New("vertexAttrib3fv"),FunctionTemplate::New(WebGLGraphicsContext::VertexAttrib3fv));
    class_proto->Set(v8::String::New("vertexAttrib4f"),FunctionTemplate::New(WebGLGraphicsContext::VertexAttrib4f));
    class_proto->Set(v8::String::New("vertexAttrib4fv"),FunctionTemplate::New(WebGLGraphicsContext::VertexAttrib4fv));

    class_proto->Set(v8::String::New("blendColor"),FunctionTemplate::New(WebGLGraphicsContext::BlendColor));
    class_proto->Set(v8::String::New("blendEquation"),FunctionTemplate::New(WebGLGraphicsContext::BlendEquation));
    class_proto->Set(v8::String::New("blendEquationSeparate"),FunctionTemplate::New(WebGLGraphicsContext::BlendEquationSeparate));
    class_proto->Set(v8::String::New("blendFunc"),FunctionTemplate::New(WebGLGraphicsContext::BlendFunc));
    class_proto->Set(v8::String::New("blendFuncSeparate"),FunctionTemplate::New(WebGLGraphicsContext::BlendFuncSeparate));
    class_proto->Set(v8::String::New("sampleCoverage"),FunctionTemplate::New(WebGLGraphicsContext::SampleCoverage));
    class_proto->Set(v8::String::New("stencilFuncSeparate"),FunctionTemplate::New(WebGLGraphicsContext::StencilFuncSeparate));
    class_proto->Set(v8::String::New("stencilOp"),FunctionTemplate::New(WebGLGraphicsContext::StencilOp));
    class_proto->Set(v8::String::New("stencilOpSeparate"),FunctionTemplate::New(WebGLGraphicsContext::StencilOpSeparate));

    class_proto->Set(v8::String::New("clearStencil"),FunctionTemplate::New(WebGLGraphicsContext::ClearStencil));
    class_proto->Set(v8::String::New("colorMask"),FunctionTemplate::New(WebGLGraphicsContext::ColorMask));
    class_proto->Set(v8::String::New("depthMask"),FunctionTemplate::New(WebGLGraphicsContext::DepthMask));
    class_proto->Set(v8::String::New("stencilMask"),FunctionTemplate::New(WebGLGraphicsContext::StencilMask));
    class_proto->Set(v8::String::New("stencilMaskSeparate"),FunctionTemplate::New(WebGLGraphicsContext::StencilMaskSeparate));
    class_proto->Set(v8::String::New("depthRange"),FunctionTemplate::New(WebGLGraphicsContext::DepthRange));
    class_proto->Set(v8::String::New("scissor"),FunctionTemplate::New(WebGLGraphicsContext::Scissor));
    class_proto->Set(v8::String::New("deleteBuffer"),FunctionTemplate::New(WebGLGraphicsContext::DeleteBuffer));
    class_proto->Set(v8::String::New("deleteProgram"),FunctionTemplate::New(WebGLGraphicsContext::DeleteProgram));
    class_proto->Set(v8::String::New("deleteShader"),FunctionTemplate::New(WebGLGraphicsContext::DeleteShader));
    class_proto->Set(v8::String::New("deleteTexture"),FunctionTemplate::New(WebGLGraphicsContext::DeleteTexture));
    class_proto->Set(v8::String::New("deleteRenderbuffer"),FunctionTemplate::New(WebGLGraphicsContext::DeleteRenderbuffer));
    class_proto->Set(v8::String::New("deleteFramebuffer"),FunctionTemplate::New(WebGLGraphicsContext::DeleteFramebuffer));
    class_proto->Set(v8::String::New("deleteFramebuffer"),FunctionTemplate::New(WebGLGraphicsContext::DeleteFramebuffer));
    class_proto->Set(v8::String::New("cullFace"),FunctionTemplate::New(WebGLGraphicsContext::CullFace));
    class_proto->Set(v8::String::New("frontFace"),FunctionTemplate::New(WebGLGraphicsContext::FrontFace));
    class_proto->Set(v8::String::New("lineWidth"),FunctionTemplate::New(WebGLGraphicsContext::LineWidth));
    class_proto->Set(v8::String::New("polygonOffset"),FunctionTemplate::New(WebGLGraphicsContext::PolygonOffset));
    class_proto->Set(v8::String::New("bindAttribLocation"),FunctionTemplate::New(WebGLGraphicsContext::BindAttribLocation));
    class_proto->Set(v8::String::New("detachShader"),FunctionTemplate::New(WebGLGraphicsContext::DetachShader));
    class_proto->Set(v8::String::New("getAttachedShaders"),FunctionTemplate::New(WebGLGraphicsContext::GetAttachedShaders));
    class_proto->Set(v8::String::New("getProgramInfoLog"),FunctionTemplate::New(WebGLGraphicsContext::GetProgramInfoLog));
    class_proto->Set(v8::String::New("getShaderSource"),FunctionTemplate::New(WebGLGraphicsContext::GetShaderSource));
    class_proto->Set(v8::String::New("isBuffer"),FunctionTemplate::New(WebGLGraphicsContext::IsBuffer));
    class_proto->Set(v8::String::New("isProgram"),FunctionTemplate::New(WebGLGraphicsContext::IsProgram));
    class_proto->Set(v8::String::New("isShader"),FunctionTemplate::New(WebGLGraphicsContext::IsShader));
    class_proto->Set(v8::String::New("isTexture"),FunctionTemplate::New(WebGLGraphicsContext::IsTexture));
    class_proto->Set(v8::String::New("isRenderbuffer"),FunctionTemplate::New(WebGLGraphicsContext::IsRenderbuffer));
    class_proto->Set(v8::String::New("isFramebuffer"),FunctionTemplate::New(WebGLGraphicsContext::IsFramebuffer));
    class_proto->Set(v8::String::New("validateProgram"),FunctionTemplate::New(WebGLGraphicsContext::ValidateProgram));
    class_proto->Set(v8::String::New("finish"),FunctionTemplate::New(WebGLGraphicsContext::Finish));
    class_proto->Set(v8::String::New("GetError"),FunctionTemplate::New(WebGLGraphicsContext::GetError));
    class_proto->Set(v8::String::New("disableVertexAttribArray"),FunctionTemplate::New(WebGLGraphicsContext::DisableVertexAttribArray));
    class_proto->Set(v8::String::New("isEnabled"),FunctionTemplate::New(WebGLGraphicsContext::IsEnabled));
    class_proto->Set(v8::String::New("copyTexImage2D"),FunctionTemplate::New(WebGLGraphicsContext::CopyTexImage2D));
    class_proto->Set(v8::String::New("texSubImage2D"),FunctionTemplate::New(WebGLGraphicsContext::TexSubImage2D));
    class_proto->Set(v8::String::New("hint"),FunctionTemplate::New(WebGLGraphicsContext::Hint));

    class_proto->Set(v8::String::New("getShaderParameter"),FunctionTemplate::New(WebGLGraphicsContext::GetShaderParameter));
    class_proto->Set(v8::String::New("getProgramParameter"),FunctionTemplate::New(WebGLGraphicsContext::GetProgramParameter));
    class_proto->Set(v8::String::New("getTexParameter"),FunctionTemplate::New(WebGLGraphicsContext::GetTexParameter));
    class_proto->Set(v8::String::New("getRenderbufferParameter"),FunctionTemplate::New(WebGLGraphicsContext::GetRenderbufferParameter));
    class_proto->Set(v8::String::New("getFramebufferAttachmentParameter"),FunctionTemplate::New(WebGLGraphicsContext::GetFramebufferAttachmentParameter));
    class_proto->Set(v8::String::New("getParameter"),FunctionTemplate::New(WebGLGraphicsContext::GetParameter));
    class_proto->Set(v8::String::New("getVertexAttribOffset"),FunctionTemplate::New(WebGLGraphicsContext::GetVertexAttribOffset));
    class_proto->Set(v8::String::New("getVertexAttrib"),FunctionTemplate::New(WebGLGraphicsContext::GetVertexAttrib));
    class_proto->Set(v8::String::New("getActiveAttrib"),FunctionTemplate::New(WebGLGraphicsContext::GetActiveAttrib));
    class_proto->Set(v8::String::New("getActiveUniform"),FunctionTemplate::New(WebGLGraphicsContext::GetActiveUniform));
    class_proto->Set(v8::String::New("getUniform"),FunctionTemplate::New(WebGLGraphicsContext::GetUniform));
    class_proto->Set(v8::String::New("checkFramebufferStatus"),FunctionTemplate::New(WebGLGraphicsContext::CheckFramebufferStatus));
    class_proto->Set(v8::String::New("readPixels"),FunctionTemplate::New(WebGLGraphicsContext::ReadPixels));
    class_proto->Set(v8::String::New("copyTexSubImage2D"),FunctionTemplate::New(WebGLGraphicsContext::CopyTexSubImage2D));
    ...
    LOGE("WebGLGraphicsContext wrap end");

    return v8::Persistent<v8::Object>::New(scope.Close(class_obj));
}

v8::Handle<v8::Value> WebGLGraphicsContext::ViewPort(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 4)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::Clear(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::ClearColor(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 4)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::Enable(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::CreateBuffer(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 0)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::BindBuffer(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::BufferData(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 3)
    {
    ...
    if (ArrayBuffer::HasInstance(args[1]))
    {
    ...
    else if (ArrayBufferView::HasInstance(args[1]))
    {
    ...
    {
        if (!context->bufferData(target, NULL, usage))
        {
...
v8::Handle<v8::Value> WebGLGraphicsContext::BufferSubData(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 3)
    {
    ...
    if (ArrayBuffer::HasInstance(args[2]))
    {
    ...
    else if (ArrayBufferView::HasInstance(args[2]))
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::DeleteBuffer(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::DeleteProgram(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::DeleteShader(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::DeleteTexture(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::DeleteRenderbuffer(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::DeleteFramebuffer(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::CreateTexture(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 0)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::BindTexture(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::CreateShader(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::ShaderSource(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::CompileShader(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::CreateProgram(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> WebGLGraphicsContext::AttachShader(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> WebGLGraphicsContext::LinkProgram(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> WebGLGraphicsContext::UseProgram(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> WebGLGraphicsContext::UniformfvImpl(const v8::FunctionCallbackInfo<v8::Value>& args, DCint index)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
    ...
    else if (Float32Array::HasInstance(args[1]))
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::UniformivImpl(const v8::FunctionCallbackInfo<v8::Value>& args, DCint index)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
    ...
    else if (Int32Array::HasInstance(args[1]))
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::Uniform1f(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::Uniform1fv(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    return UniformfvImpl(args, 1);
}

v8::Handle<v8::Value> WebGLGraphicsContext::Uniform1i(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::Uniform1iv(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    return UniformivImpl(args, 1);
}

v8::Handle<v8::Value> WebGLGraphicsContext::Uniform2f(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 3)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::Uniform2fv(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    return UniformfvImpl(args, 2);
}

v8::Handle<v8::Value> WebGLGraphicsContext::Uniform2i(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 3)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::Uniform2iv(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    return UniformivImpl(args, 2);
}

v8::Handle<v8::Value> WebGLGraphicsContext::Uniform3f(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 4)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::Uniform3fv(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    return UniformfvImpl(args, 3);
}

v8::Handle<v8::Value> WebGLGraphicsContext::Uniform3i(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 4)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::Uniform3iv(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    return UniformivImpl(args, 3);
}

v8::Handle<v8::Value> WebGLGraphicsContext::Uniform4f(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 5)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::Uniform4fv(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    return UniformfvImpl(args, 4);
}

v8::Handle<v8::Value> WebGLGraphicsContext::Uniform4i(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 5)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::Uniform4iv(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    return UniformivImpl(args, 4);
}

v8::Handle<v8::Value> WebGLGraphicsContext::UniformMatrixfvImpl(const v8::FunctionCallbackInfo<v8::Value>& args, DCint index)
{
    HandleScope scope;
    if (args.Length() != 3)
    {
    ...
    else if (Float32Array::HasInstance(args[2]))
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::UniformMatrix2fv(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    return UniformMatrixfvImpl(args, 2);
}

v8::Handle<v8::Value> WebGLGraphicsContext::UniformMatrix3fv(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    return UniformMatrixfvImpl(args, 3);
}

v8::Handle<v8::Value> WebGLGraphicsContext::UniformMatrix4fv(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    return UniformMatrixfvImpl(args, 4);
}

v8::Handle<v8::Value> WebGLGraphicsContext::GetAttribLocation(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> WebGLGraphicsContext::GetUniformLocation(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> WebGLGraphicsContext::EnableVertexAttribArray(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> WebGLGraphicsContext::VertexAttribPointer(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> WebGLGraphicsContext::DrawArrays(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> WebGLGraphicsContext::DepthFunc(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::ClearDepth(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::Flush(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 0)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::DrawElements(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> WebGLGraphicsContext::GetShaderInfoLog(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::Disable(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::TexImage2D(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    ...
    switch (len)
    {
        case 6:
            ...
            else if (Image::HasInstance(args[5]))
            {
        ...
        case 9:
            ...
            else if (ArrayBufferView::HasInstance(args[8]))
            {
...
v8::Handle<v8::Value> WebGLGraphicsContext::TexParameterf(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 3)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::TexParameteri(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 3)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::ActiveTexture(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::GenerateMipmap(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope Scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::PixelStorei(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope Scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::CreateRenderbuffer(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 0)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::CreateFramebuffer(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 0)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::BindRenderbuffer(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::RenderbufferStorage(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 4)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::FramebufferTexture2D(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 5)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::FramebufferRenderbuffer(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 4)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::BindFramebuffer(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::BlendColor(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 4)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::BlendEquation(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::BlendEquationSeparate(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::BlendFunc(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::BlendFuncSeparate(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 4)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::SampleCoverage(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::StencilFuncSeparate(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 4)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::StencilOp(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 3)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::StencilOpSeparate(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 4)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::ClearStencil(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::ColorMask(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 4)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::DepthMask(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::StencilMask(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::StencilMaskSeparate(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::DepthRange(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::Scissor(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 4)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::CullFace(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::FrontFace(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::LineWidth(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::PolygonOffset(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::BindAttribLocation(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 3)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::DetachShader(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::GetAttachedShaders(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
    ...
    LOGE("GetAttachedShaders   ---------------  size :%d", size);
...
v8::Handle<v8::Value> WebGLGraphicsContext::GetProgramInfoLog(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::GetShaderSource(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::IsBuffer(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::IsProgram(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::IsShader(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::IsTexture(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::IsRenderbuffer(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::IsFramebuffer(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::ValidateProgram(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::Finish(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 0)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::GetError(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 0)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::DisableVertexAttribArray(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::IsEnabled(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::CopyTexImage2D(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 8)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::CopyTexSubImage2D(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 8)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::TexSubImage2D(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    ...
    switch (len)
    {
        case 7:
            ...
            else if (Image::HasInstance(args[6]))
            {
        ...
        case 9:
            ...
            {
                abv = NULL;
                //LOGE("TexSubImage2D :abv is null");
            }
            else if (ArrayBufferView::HasInstance(args[8]))
            {
                abv = ObjectWrap::Unwrap<ArrayBufferView>(args[8]->ToObject());
                //LOGE("TexSubImage2D :abv is not null");
            }
            else
            {
...
v8::Handle<v8::Value> WebGLGraphicsContext::Hint(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::VertexAttrib1f(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::VertexAttrib2f(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 3)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::VertexAttrib3f(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 4)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::VertexAttrib4f(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 5)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::VertexAttrib1fv(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::VertexAttrib2fv(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::VertexAttrib3fv(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::VertexAttrib4fv(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::GetProgramParameter(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::GetShaderParameter(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::GetTexParameter(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::GetRenderbufferParameter(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::GetFramebufferAttachmentParameter(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 3)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::GetParameter(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::GetVertexAttrib(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::GetVertexAttribOffset(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::GetActiveAttrib(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::GetActiveUniform(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::GetUniform(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::CheckFramebufferStatus(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::ReadPixels(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length() != 7)
    {
    ...
    if (!ArrayBufferView::HasInstance(args[6]))
    {
...
v8::Handle<v8::Value> WebGLGraphicsContext::SwapBuffer(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    HandleScope scope;
    if (args.Length()!=0)
    {
