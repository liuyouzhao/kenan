...
void V8PixelArray::SetLength(v8::Local<v8::String> property, v8::Local<v8::Value> value, const PropertyCallbackInfo& info)
{
/*
HAS_FIXED_POINT
...
v8::Handle<v8::Value> V8PixelArray::GetLength(v8::Local<v8::String> property, const PropertyCallbackInfo& info)
{
    HandleScope scope;
    Local<Object> self = info.Holder();
    Local<External> wrap = Local<External>::Cast(self->GetInternalField(0));
