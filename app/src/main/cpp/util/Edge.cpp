...
int Edge::setLine(const SkPoint& p0, const SkPoint& p1,
...
int Edge::updateLine(SkFixed x0, SkFixed y0, SkFixed x1, SkFixed y1)
{
...
void Edge::chopLineWithClip(const SkIRect& clip)
{
    int top = fFirstY;
