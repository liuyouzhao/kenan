...
v8::Handle<v8::Value> V8ImageData::GetData(v8::Local<v8::String> property, const AccessorInfo& info)
{
    HandleScope scope;
...
void V8ImageData::SetData(v8::Local<v8::String> property, v8::Local<v8::Value> value, const AccessorInfo& info)
{
    HandleScope scope;
...
v8::Handle<v8::Value> V8ImageData::GetWidth(v8::Local<v8::String> property, const AccessorInfo& info)
{
    HandleScope scope;
    CASTTOCLASS(ImageData, info);
...
void V8ImageData::SetWidth(v8::Local<v8::String> property, v8::Local<v8::Value> value, const AccessorInfo& info)
{
    HandleScope scope;
}

v8::Handle<v8::Value> V8ImageData::GetHeight(v8::Local<v8::String> property, const AccessorInfo& info)
{
    HandleScope scope;
    CASTTOCLASS(ImageData, info);
...
void V8ImageData::SetHeight(v8::Local<v8::String> property, v8::Local<v8::Value> value, const AccessorInfo& info)
{
    HandleScope scope;
}
